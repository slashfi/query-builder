...
type IfClause = <
  ConditionClauseBuilder extends ExpressionBuilderShape<GenericAny>,
  TrueExprBuilder extends ExpressionBuilderShape<GenericAny>,
  FalseExprBuilder extends ExpressionBuilderShape<GenericAny>,
