 ...
 */
export type Flat<T extends ReadonlyArray<ReadonlyArray<GenericAny>>> =
  T extends [
    infer U extends ReadonlyArray<GenericAny>,
    infer J extends ReadonlyArray<ReadonlyArray<GenericAny>>,
  ]
    ? [...U, ...Flat<J>]
    : [];
...
export type CheckForTypecheckError<
  T extends ReadonlyArray<GenericAny>,
  Tail = T,
> = T extends [infer U, ...infer J extends ReadonlyArray<GenericAny>]
  ? U extends TypecheckError<GenericAny, GenericAny>
    ? U
...
export type SomeValueInFirstExtendsSecond<
  T extends ReadonlyArray<GenericAny>,
  R extends ReadonlyArray<GenericAny>,
> = T extends readonly [infer U, ...infer J extends ReadonlyArray<GenericAny>]
  ? U extends R[number]
    ? true
 ...
 */
export type FilterNeverValuesFromReadonlyArray<
  T extends ReadonlyArray<GenericAny>,
> = T extends readonly [infer U, ...infer J extends ReadonlyArray<GenericAny>]
  ? [U] extends [never]
