...
> = Selection extends readonly [infer U, ...infer J extends SelectionArray]
  ? U extends ClauseForSelectListItem<
      infer K extends ExpressionBase<GenericAny>,
      infer Alias
    >
...
export type TypeNarrowSelectItemFromBooleanExpression<
  ...
  S extends BaseDbDiscriminator,
> = Expr extends ExpressionLeftRightBinary<GenericAny, GenericAny, GenericAny>
  ? TypeNarrowSelectItemForLeftRightBinaryExpr<
      ...
      S
    >
  : Expr extends ExpressionRightUnaryBinary<GenericAny, GenericAny>
...
> = Expr extends ExpressionRightUnaryBinary<infer LeftExpr, infer Op>
  ? LeftExpr extends ExpressionColumn<GenericAny, GenericAny, S>
    ? Op extends OperatoryUnaryIs<'NULL', true>
      ? SelectItem['expr'] extends ExpressionSelectColumns<
          GenericAny,
          GenericAny
        >
        ? /*
