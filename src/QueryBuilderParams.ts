...
export interface QueryBuilderParams<S extends BaseDbDiscriminator> {
  ...
  groupByClause: ReadonlyArray<ClauseForGroupByList<GenericAny>>;
  offset?: number;
  limit?: number;
  ...
  forUpdate?: 'update' | 'share' | undefined;
  skipLocked?: boolean;
}
...
export type GenericQueryBuilderParams<
  ...
  Req extends {
    ...
    [Key in keyof QueryBuilderParams<S>]: GenericAny;
  },
> = {
...
> = AnyOf<
  [
    IsAny<Params>,
    IsAny<Params['offset']>,
    AllOf<[undefined extends Params['offset'] ? true : false]>,
  ]
>;
